...
const LobbyUserDetailsPage = function (): JSX.Element {
    ...
    useEffect(() => {
        axios.get<any, AxiosResponse<any, any>>(`http://localhost:8080/users/GetDetailsByLobbyUserId/${userId}`, {
            headers: {
    ...
    return (<>
        ...
        <div className="w-3/5 mx-auto py-5">
            ...
            {
                userDetails.replays ? <div id="replay-container" className="text-sm p-6 bg-white shadow-md" style={{ border: "1px solid", borderRadius: "4px" }}>
