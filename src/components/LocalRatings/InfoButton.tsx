...
const InfoButton = (props: InfoButtonProps): JSX.Element => {
    ...
    return (
        <button onClick={onClick} className="mb-5 inline-flex items-center">
            ...
            <span title={props.text} className="items-center inline-flex text-ellipsis overflow-hidden text-nowrap">{props.text}</span>
        </button>
    );
};
