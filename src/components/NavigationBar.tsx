...
const NavigationBar = () => {
    ...
    const lightButton =<button className="theme-toggle mr-2" onClick={onClick} id="theme-toggle" title="Toggles light & dark" data-theme={lightMode} aria-label={lightMode} aria-live="polite">
    {
